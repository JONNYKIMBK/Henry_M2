...
const Timer = () => {
  ...
  function toggle() {
    if(tipo=== "Cuenta Regresiva" && segundos<0) {
  ...
  return (
    <div className="app">
      ...
      {tipo === 'Cuenta Regresiva' && <input type="number" ref={myRef} onChange={agregaSegundos} placeholder="Ingresa Segundos" autoComplete="off"/>}    </div>
  );
};
